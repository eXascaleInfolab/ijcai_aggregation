...
ZenCrowd                           & Accuracy     & 0.701          & 0.686          & \textbf{0.733} & 0.702*         & 0.688          & 0.651          & 0.674*         & \textbf{0.664} & \textbf{0.683} & 0.627*         \\ %\cline{2-12} 
...
\multirow{2}{*}{OpenCrowd}   & Accuracy     & \textbf{0.724} & \textbf{0.733} & 0.725*         & \textbf{0.733} & \textbf{0.75}  & \textbf{0.673} & \textbf{0.674} & 0.662*         & 0.672*         & \textbf{0.686} \\ % \cline{2-12} 
                             & auprc   & \textbf{0.265} & \textbf{0.277} & \textbf{0.273} & \textbf{0.299} & \textbf{0.388} & \textbf{0.207} & \textbf{0.213} & \textbf{0.267} & \textbf{0.300} & \textbf{0.333} \\ \bottomrule
\end{tabular}
 \label{sec:compres}  
\end{table*}
