...
that incorporates priors in modeling worker reliability. To apply these methods to our problem, we use negative sampling to simulate a worker' answers of non-influencers by sampling the candidate influencers she does not name \jie{is this clear}; we empirically determine the optimal sampling rates for each comparison method. 
