...
\multirow{2}{*}{OpenCrowd}   & Accuracy     & \textbf{0.733} & \textbf{0.740} & \textbf{0.751}         & \textbf{0.769} & \textbf{0.889}  & \textbf{0.666} & \textbf{0.676} &\textbf{0.687}         & \textbf{0.697}         & \textbf{0.742} \\ % \cline{2-12} 
                             & AUC   & \textbf{0.304} & \textbf{0.350} & \textbf{0.350} & \textbf{0.452} & \textbf{0.495} & \textbf{0.268} & \textbf{0.259} & \textbf{0.280} & \textbf{0.301} & \textbf{0.280} \\ \bottomrule
\end{tabular}
 \label{sec:compres}  
\end{table*}
...
\begin{subfigure}[t]{0.4\columnwidth}
  ...
  \centering
    ...
    \end{subfigure}% 
        ...
        \caption{Worker reliability distribution}\label{fig:worker_reliability}
    \end{subfigure}
