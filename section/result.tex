...
and considered as relevant candidate influencers in estimating that worker's reliability. 
We apply a grid search in \{0, 1, 5, 10, 20, 50, 100\} to
investigate the impact of negative sampling. The results are shown in Figure~\ref{fig:sys_perf_fashion}
and~\ref{fig:sys_perf_it} for respectively the Fashion domain and the IT domain.
...
\end{tikzpicture}
 ...
 \end{subfigure}
   \caption{Fashion dataset (supervision 60\%)}  \label{fig:sys_perf_fashion} 
\end{figure}
...
\end{tikzpicture}
 ...
 \end{subfigure}
   \caption{IT dataset (supervision 60\%)}\label{fig:sys_perf_it} 
\end{figure}
...
\multirow{2}{*}{DS}          & acc     & 0.689          & 0.716*         & 0.703          & 0.688          & 0.711*         & 0.662          & 0.660          & 0.626          & 0.641          & 0.536          \\ \cline{2-12} 
                             & aucpr   & 0.191          & 0.169          & 0.242          & 0.244          & 0.263          & 0.174          & 0.203*         & 0.222*         & 0.255          & 0.272          \\ \hline
\multirow{2}{*}{GLAD}        & acc     & 0.697          & 0.716*         & 0.724          & 0.700          & 0.688          & 0.669*         & 0.667          & 0.637          & 0.672          & 0.595          \\ \cline{2-12} 
                             & aucpr   & 0.183          & 0.189          & 0.229          & 0.224          & 0.263          & 0.150          & 0.186          & 0.138          & 0.219          & 0.307*         \\ \hline
ZC                           & acc     & 0.701          & 0.686          & \textbf{0.733} & 0.702*         & 0.688          & 0.651          & 0.674*         & \textbf{0.664} & \textbf{0.683} & 0.627*         \\ \cline{2-12} 
                             & aucpr   & 0.157          & 0.175          & 0.203*         & 0.239          & 0.287*         & 0.146          & 0.198          & 0.212          & 0.246          & 0.234          \\ \hline
\multirow{2}{*}{LFC}         & acc     & 0.721*         & 0.694          & 0.718          & 0.691          & 0.755          & 0.653          & 0.627          & 0.643          & 0.616          & 0.636          \\ \cline{2-12} 
                             & aucpr   & 0.203*         & 0.203*         & 0.225          & 0.264*         & 0.277          & 0.189*         & 0.192          & 0.215          & 0.276*         & 0.307*         \\ \hline
...
\end{tabular}
   \caption{Performance in terms of Accuracy (acc) and AUCPR where best performance is highledted in bold and the second best performance is marked by `*' }\label{tab:comparision} 
\end{table*}
\label{sec:compres}