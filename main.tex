...
Finding users in a network with such a social influence is becoming a fundamental 
...
and are recognized with some intuitive properties such as a high number of 
followers, a relatively small number of followees and a regular feed about a certain topic in one or 
more social media platforms. Existing work tackles the problem from this angle where several approaches have been proposed to find influencers in a network by performing content analysis and/or link analysis. However, the
task of finding influencers remains a challenging task as these influencers
...
(and hence identify the experts in the crowd).
