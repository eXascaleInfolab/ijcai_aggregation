...
in such case which one is more correct in our case?, also it is better to use Social Influence Analysis
or should I be more specific and say user classification?}
\subsection{Truth Inference}
A number of aggregation techniques have been proposed. In \cite{catd}, the authors 
propose a weighted majority voting. Worker's quality is assessed by two measures: 
...
worker's quality is modeled in a wider range (in $(-\infty,+\infty)$.1
...
intuition other then using autoencoders for aggregation}
